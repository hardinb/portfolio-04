...
ggplot()+
  ...
  geom_smooth(data = no_benefit, aes(x = A_goal2_centered, y = A_statehonesty), method = "lm", color = "blue3", linetype = "dashed")+
  geom_smooth(data = yes_benefit, aes(x = A_goal2_centered, y = A_statehonesty), method = "lm", color = "black")+
  theme_classic()+
  geom_point(data = yes_benefit, aes(x = A_goal2_centered, y = A_statehonesty), color = "black", alpha = 0.6)+
  geom_point(data = no_benefit, aes(x = A_goal2_centered, y = A_statehonesty), color = "blue", alpha = 0.4)+
  geom_vline(xintercept = 0, linetype = "dashed", linewidth = 0.6)+
  scale_y_continuous(
    limits = c(1, 4.3),
    expand = c(0, 0)
...
ggplot()+
  ...
  geom_smooth(data = no_benefit, aes(x = A_goal7_centered, y = A_statehonesty), method = "lm", color = "blue3", linetype = "dashed")+
  geom_smooth(data = yes_benefit, aes(x = A_goal7_centered, y = A_statehonesty), method = "lm", color = "black")+
  theme_classic()+
  geom_vline(xintercept = 0, linetype = "dashed", linewidth = 0.6)+
  scale_y_continuous(
    limits = c(1, 4.3),
